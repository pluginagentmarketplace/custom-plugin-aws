...
This guide provides comprehensive documentation for the **aws-cloudformation** skill in the custom-plugin-aws plugin.
...
```bash
# Invoke the skill
claude "aws-cloudformation - [your task description]"

# Example
claude "aws-cloudformation - analyze the current implementation"
```
...
def implement_aws_cloudformation(input_data):
    """
    Implement aws-cloudformation functionality.
