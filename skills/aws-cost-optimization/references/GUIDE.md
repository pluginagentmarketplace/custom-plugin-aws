...
This guide provides comprehensive documentation for the **aws-cost-optimization** skill in the custom-plugin-aws plugin.
...
```bash
# Invoke the skill
claude "aws-cost-optimization - [your task description]"

# Example
claude "aws-cost-optimization - analyze the current implementation"
```
...
def implement_aws_cost_optimization(input_data):
    """
    Implement aws-cost-optimization functionality.
