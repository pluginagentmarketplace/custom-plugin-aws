# Aws S3 Management Guide

## Overview

This guide provides comprehensive documentation for the **aws-s3-management** skill in the custom-plugin-aws plugin.
...
```bash
# Invoke the skill
claude "aws-s3-management - [your task description]"

# Example
claude "aws-s3-management - analyze the current implementation"
```
...
def implement_aws_s3_management(input_data):
    """
    Implement aws-s3-management functionality.
