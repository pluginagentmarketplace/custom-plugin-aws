...
This guide provides comprehensive documentation for the **aws-ecs** skill in the custom-plugin-aws plugin.
...
```bash
# Invoke the skill
claude "aws-ecs - [your task description]"

# Example
claude "aws-ecs - analyze the current implementation"
```
...
def implement_aws_ecs(input_data):
    """
    Implement aws-ecs functionality.
