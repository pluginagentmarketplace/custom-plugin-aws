...
This guide provides comprehensive documentation for the **aws-cloudwatch** skill in the custom-plugin-aws plugin.
...
```bash
# Invoke the skill
claude "aws-cloudwatch - [your task description]"

# Example
claude "aws-cloudwatch - analyze the current implementation"
```
...
def implement_aws_cloudwatch(input_data):
    """
    Implement aws-cloudwatch functionality.
