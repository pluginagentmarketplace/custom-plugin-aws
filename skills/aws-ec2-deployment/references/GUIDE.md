...
This guide provides comprehensive documentation for the **aws-ec2-deployment** skill in the custom-plugin-aws plugin.
...
```bash
# Invoke the skill
claude "aws-ec2-deployment - [your task description]"

# Example
claude "aws-ec2-deployment - analyze the current implementation"
```
...
def implement_aws_ec2_deployment(input_data):
    """
    Implement aws-ec2-deployment functionality.
