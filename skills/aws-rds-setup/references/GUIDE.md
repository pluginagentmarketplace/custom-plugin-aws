...
This guide provides comprehensive documentation for the **aws-rds-setup** skill in the custom-plugin-aws plugin.
...
```bash
# Invoke the skill
claude "aws-rds-setup - [your task description]"

# Example
claude "aws-rds-setup - analyze the current implementation"
```
...
def implement_aws_rds_setup(input_data):
    """
    Implement aws-rds-setup functionality.
