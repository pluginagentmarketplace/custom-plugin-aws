...
This guide provides comprehensive documentation for the **aws-security-best-practices** skill in the custom-plugin-aws plugin.
...
```bash
# Invoke the skill
claude "aws-security-best-practices - [your task description]"

# Example
claude "aws-security-best-practices - analyze the current implementation"
```
...
def implement_aws_security_best_practices(input_data):
    """
    Implement aws-security-best-practices functionality.
