...
This guide provides comprehensive documentation for the **aws-codepipeline** skill in the custom-plugin-aws plugin.
...
```bash
# Invoke the skill
claude "aws-codepipeline - [your task description]"

# Example
claude "aws-codepipeline - analyze the current implementation"
```
...
def implement_aws_codepipeline(input_data):
    """
    Implement aws-codepipeline functionality.
