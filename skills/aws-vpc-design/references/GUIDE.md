...
This guide provides comprehensive documentation for the **aws-vpc-design** skill in the custom-plugin-aws plugin.
...
```bash
# Invoke the skill
claude "aws-vpc-design - [your task description]"

# Example
claude "aws-vpc-design - analyze the current implementation"
```
...
def implement_aws_vpc_design(input_data):
    """
    Implement aws-vpc-design functionality.
