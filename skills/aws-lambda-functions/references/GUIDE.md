...
This guide provides comprehensive documentation for the **aws-lambda-functions** skill in the custom-plugin-aws plugin.
...
```bash
# Invoke the skill
claude "aws-lambda-functions - [your task description]"

# Example
claude "aws-lambda-functions - analyze the current implementation"
```
...
def implement_aws_lambda_functions(input_data):
    """
    Implement aws-lambda-functions functionality.
