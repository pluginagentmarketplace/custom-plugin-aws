...
This guide provides comprehensive documentation for the **aws-iam-setup** skill in the custom-plugin-aws plugin.
...
```bash
# Invoke the skill
claude "aws-iam-setup - [your task description]"

# Example
claude "aws-iam-setup - analyze the current implementation"
```
...
def implement_aws_iam_setup(input_data):
    """
    Implement aws-iam-setup functionality.
